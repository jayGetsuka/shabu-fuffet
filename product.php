...
<body>
    ...
    <form>
        ...
        <div class="input-group flex-nowrap">
            ...
            <input type="text" class="form-control" placeholder="Food name" aria-label="Username" aria-describedby="addon-wrapping">
        </div>
            ...
            <select class="form-select" aria-label="Default select example">
                    <option selected>เลือกประเภทเมนู</option>
                    <option value="1">เนื้อ</option>
                    <option value="2">เนื้อหมู<i class="fas fa-bacon"></i></option>
                    <option value="3">ผัก</option>
                    <option value="4">เนื้อปลา</option>
                    <option value="5">ของกินเล่น</option>

            </select>
                
            </div>
            <div class="btn-add-menu">
                <button class="btn-green"><i class="fas fa-plus-circle"></i><span>เพิ่มเมนู</span></button>
            </div>
